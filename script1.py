...
def arch(fi, rep1, rep2):
	fin = open('/mnt/tmp/sandrapc2/practica_creativa2/bookinfo/src/productpage/' + fi, 'r')

	with fin as file:
		x= file.read()
	fin.close()

	fin = open('/mnt/tmp/sandrapc2/practica_creativa2/bookinfo/src/productpage/' + fi, 'w')
	with fin as file:
...
os.chdir('/mnt/tmp/sandrapc2/practica_creativa2')

#Modificamos el fichero requirements.txt
arch('requirements.txt', 'urllib3==1.26.5', 'urllib3==1.26.13')
...
subprocess.run(["pip3", "install", '-r', '/mnt/tmp/sandrapc2/practica_creativa2/bookinfo/src/productpage/requirements.txt'])
...
#Modificamos el script /mnt/tmp/practica_creativa2/src/productpage/productpage_monolith.py para cambiar el puerto por otro introducido
...
subprocess.run(["python3", "/mnt/tmp/sandrapc2/practica_creativa2/bookinfo/src/productpage/productpage_monolith.py", puerto])
