...
def arch(fi, rep1, rep2):
	fin = open('/scriptsCDPS/practica_creativa2/bookinfo/src/productpage/' + fi, 'r')

	with fin as file:
		x= file.read()
	fin.close()

	fin = open('/scriptsCDPS/practica_creativa2/bookinfo/src/productpage/' + fi, 'w')
	with fin as file:
...
os.chdir('/scriptsCDPS/practica_creativa2')
...
subprocess.run(["pip3", "install", '-r', '/scriptsCDPS/practica_creativa2/bookinfo/src/productpage/requirements.txt'])
...
subprocess.run(["python3", "/scriptsCDPS/practica_creativa2/bookinfo/src/productpage/productpage_monolith.py", puerto])
